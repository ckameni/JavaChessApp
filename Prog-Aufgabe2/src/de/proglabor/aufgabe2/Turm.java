...
public class Turm extends Figur{
	...
	// Turm kann bewegt werden, wenn
		...
		if (FarbeDerFigur.equals(amZug) && !startpos.equals(zielpos) && wegFrei &&
				zielPositionVomGegnerBelegt==3){
			return spaltenDifferenz == 0 || zeilenDifferenz == 0 ;
	...
	public  boolean kannSchlagen(String startpos , String zielpos,
		 ...
		 *  3 - Eine gegnerische Figur befindet sich auf der Zielposition
		 */
		if (FarbeDerFigur.equals(amZug) && !startpos.equals(zielpos) && wegFrei
...
//			int tmp = zielZeile;
//			zielZeile = startZeile;
//			startZeile=tmp;
//		}
	if (Math.abs(startZeile-zielZeile)>1 || Math.abs(startSpalte-zielSpalte)>1){
		int j=startSpalte;	
	...
	/**
	 *  Funktion ist wichtig um zu prüfen, ob ein Turm den gegnerische König 
